...
public class InfraConfiguration {
    ...
    @Bean
    public ConfigurerModule commandHandlerInterceptorConfigurer(List<MessageHandlerInterceptor<? super CommandMessage<?>>> interceptors) {
        return configurer -> interceptors.forEach(i -> configurer.registerCommandHandlerInterceptor(c -> i));
    }

    @ConditionalOnClass(MessageHandlerInterceptor.class)
    @Bean
    public ConfigurerModule queryHandlerInterceptorConfigurer(List<MessageHandlerInterceptor<? super QueryMessage<?,?>>> interceptors) {
